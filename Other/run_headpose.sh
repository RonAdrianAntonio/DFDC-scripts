...
headpose_landmark_loc="/home/leenooks/Documents/Coding/AI_Proj/HeadPose/step1_model/prelim_dfdc_split_step1"
headpose_headpose_loc="/home/leenooks/Documents/Coding/AI_Proj/HeadPose/step2_model/prelim_dfdc_split_step2"
headpose_final_model_loc="/home/leenooks/Documents/Coding/AI_Proj/HeadPose/final_models/prelim_dfdc_split_model"
...
optirun python $headpose_step2_loc --landmark_info_path=$headpose_landmark_loc --headpose_save_path=$headpose_headpose_loc

optirun python $headpose_step3_loc --headpose_path=$headpose_headpose_loc --model_save_path=$headpose_final_model_loc

python $headpose_run_loc --input_dir=$dfdc_syms_loc/test --classifier_path=$headpose_final_model_loc --save_file=$headpose_savefile_loc
